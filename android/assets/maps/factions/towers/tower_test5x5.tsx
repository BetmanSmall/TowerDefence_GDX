...
<tileset name="tower_test5x5" tilewidth="128" tileheight="128" tilecount="1" columns="1">
 <properties>
  <property name="factionName" value="Faction1"/>
  <property name="name" value="tower_test5x5"/>
  <property name="radiusDetection" value="5"/>
