...
<tileset name="tower_test6x6" tilewidth="192" tileheight="192" tilecount="1" columns="1">
 <properties>
  <property name="factionName" value="Faction1"/>
  <property name="name" value="tower_test6x6"/>
  <property name="radiusDetection" value="6"/>
