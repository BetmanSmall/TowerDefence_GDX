...
<tileset name="towerFreeze6" tilewidth="64" tileheight="64" tilecount="6" columns="2">
 <properties>
  <property name="factionName" value="Faction1"/>
  <property name="name" value="Freeze Tower 6"/>
  ...
  <property name="shellAttackType" value="MassAddEffect"/>
