...
<waves allTogether="false"> <!-- allTogether=true - волны буду спавнить крипов после startToMove все вместе. allTogether=false - волны буду ждать предыдущию и нажатаю кнопку от пользователя и когда нету крипов на игровом поле -->
    ...
    <!-- startToMove -> delay-->
    <wave spawnPointX="0" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
    ...
    <wave spawnPointX="0" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        ...
        <unit templateName="unit3_footman" amount="3"/>
        <!-- <unit templateName="unit4_catapult" amount="2"/> -->
    </wave>
    <wave spawnPointX="0" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <!-- <unit templateName="unit1_grunt" amount="1"/> -->
    ...
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit7_dragon" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit8_ogre" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit9_peon" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit10_ballista" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit11_elven_archer" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit12_gryphon_rider" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit13_knight" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit14_mage" amount="5"/>
    </wave>
    <wave spawnPointX="15" spawnPointY="0" exitPointX="15" exitPointY="30" spawnInterval="3" startToMove="0">
        <unit templateName="unit15_peasant" amount="5"/>
    </wave>
    ...
    <wave spawnPointX="15" spawnPointY="31" exitPointX="0" exitPointY="0" spawnInterval="0.5" startToMove="1">
    ...
    <wave spawnPointX="15" spawnPointY="31" exitPointX="0" exitPointY="0" spawnInterval="0.5" startToMove="2">
    ...
    <waveForUser spawnPointX="15" spawnPointY="31" exitPointX="15" exitPointY="0"/>
</waves>