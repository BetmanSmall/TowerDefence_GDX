...
//		creeps = new ArrayList<com.betmansmall.game.gameLogic.Creep>();
//		towers = new ArrayList<com.betmansmall.game.gameLogic.Tower>();
...
//				stepsForWaveAlgorithm.put(new GridPoint2(tmpX, tmpY), 0);
//			}
//		}
//
//		stepsForWaveAlgorithm.put(new GridPoint2(x, y), 1);
//
//		waveStep(x, y, 1);
//	}
//
...
//		return stepsForWaveAlgorithm.get(new GridPoint2(x, y));
//	}
//
//	void setStepCell(int x, int y, int step) {
//		stepsForWaveAlgorithm.put(new GridPoint2(x, y), step);
//	}
//
//	int stepAllCreeps() {
...
//		showCreeps();
//		stepsForWaveAlgorithm = new HashMap<GridPoint2, Integer>();
	}
...
//		}
//
//		creeps.add(new com.betmansmall.game.gameLogic.Creep(_layer, waterTiles.get("1"), new GridPoint2(3,4)));
//
...
//					creeps.add(new com.betmansmall.game.gameLogic.Creep(_layer, waterTiles.get("1"), new GridPoint2(x, y)));
//				}
